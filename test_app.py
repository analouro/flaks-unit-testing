...
# QA Community exercise for Unit Testing
# Write a test class to test Create funcionality (aka create a new registree using the app)

class TestCreate(TestBase):
    def test_create_registree(self):
        response = self.client.post(url_for('home'), data={"name":"MrMan"}) # change from .get to .post because you analyse what is being added by the user in the web form
